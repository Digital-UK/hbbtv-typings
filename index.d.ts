...
/// <reference path="./types/FavouriteList.d.ts" />
/// <reference path="./types/FavouriteListCollection.d.ts" />
...
/// <reference path="./types/ParentalRating.d.ts" />
/// <reference path="./types/Programme.d.ts" />
/// <reference path="./types/ProgrammeCollection.d.ts" />
